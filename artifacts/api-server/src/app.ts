...
import { enforceBrowserOrigin, protectApiRequests, securityHeaders } from "./middlewares/security";
...
app.use(express.json({
  ...
  verify: (req, _res, buffer) => {
    (req as unknown as Request & { rawBody?: Buffer }).rawBody = Buffer.from(buffer);
  },
}));
